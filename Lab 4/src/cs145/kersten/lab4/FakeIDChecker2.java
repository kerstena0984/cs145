...
public class FakeIDChecker2
{
	public static void main(String[] args)
	{
		...
		PersonalInfo[] people = {
				...
				new MinnesotaInfo("Joe", "Schmo", null, 'M', 7, 5, 1979, "K000356748932"),
				...
				new WisconsinInfo("Joe", "Schmo", null, 'M', 7, 5, 1979,   "S6603567916707"),
				new WisconsinInfo("John", "Allsoran", "Doe", 'M', 28, 2, 1935,   "D653-3733-5068-02"),
				new WisconsinInfo("Suzy", "Morgan", "Stanley", 'W', 7, 11, 1980, "S6603568089302"),
		};
