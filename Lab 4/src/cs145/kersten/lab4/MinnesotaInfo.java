...
public class MinnesotaInfo extends PersonalInfo
{
    private static final int DL_NUMBER_LENGTH = 13;
    
    public MinnesotaInfo(String firstName, String middleName, String lastName, char gender, int birthDay, int birthMonth, int birthYear, String dlNumber)
    {
